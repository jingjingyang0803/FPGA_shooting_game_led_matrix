...
ARCHITECTURE struct OF tb_serial_tx IS
   ...
   COMPONENT c5_b1_Serial_Data_Transmit
   PORT (
      bit_in   : IN     std_logic ;
      clk      : IN     std_logic ;
      rst_n    : IN     std_logic ;
   ...
   FOR ALL : c5_b1_Serial_Data_Transmit USE ENTITY alien_game_lib.c5_b1_Serial_Data_Transmit;
...
BEGIN
   ...
   U_0 : c5_b1_Serial_Data_Transmit
      PORT MAP (
         bit_in   => bit_in,
         clk      => clk,
         rst_n    => rst_n,
