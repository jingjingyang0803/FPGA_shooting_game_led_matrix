...
set_property MARK_DEBUG true [get_nets {alien_y[0]}]
set_property MARK_DEBUG true [get_nets {alien_color[7]}]
set_property MARK_DEBUG true [get_nets {alien_color[23]}]
set_property MARK_DEBUG true [get_nets U_3/dir_q]
set_property MARK_DEBUG true [get_nets {U_3/alien_x[1]}]
set_property MARK_DEBUG true [get_nets {U_3/alien_x[0]}]
set_property MARK_DEBUG true [get_nets U_3/U_0/enable]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {alien_y[0]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 2 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {alien_x[0]} {alien_x[1]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 2 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {alien_color[7]} {alien_color[23]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list U_3/dir_q]]
create_debug_port u_ila_0 probe
